...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="wrap">
			...
			<p class="message">If you are the developer of this website, please define a <kbd><?php echo $conf->default_controller; ?></kbd> controller to get rid of this message.</p>
